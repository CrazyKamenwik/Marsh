...
namespace TicketSystem.Tests.UnitTests.ServicesTests
{
    public class TicketServiceTest
    {
        ...
        public TicketServiceTest()
        {
            ...
            _ticketService = new TicketService(_ticketRepositoryMock.Object, _mapperMock.Object, _userServiceMock.Object, _loggerMock.Object);
        }

        [Fact]
        public async Task GetById_ShouldReturnTicketAndCorrectMapping()
        {
            // Arrange
        ...
        [Fact]
        public async Task Get_ShouldReturnTicketsAndCorrectMapping()
        {
            // Arrange
        ...
        [Fact]
        public async Task Add_ShouldReturnTicketAndCorrectMapping()
        {
            // Arrange
        ...
        [Fact]
        public async Task Update_ShouldReturnTicketAndCorrectMapping()
        {
            // Arrange
            _mapperMock.Setup(x => x.Map<Ticket>(_ticketsEntity.First()))
                .Returns(_tickets.First());
        ...
        [Fact]
        public async Task CloseOpenTickets_ShouldCallGetWithIncludeAndCloseOneOpenTicket()
        {
            // Arrange
